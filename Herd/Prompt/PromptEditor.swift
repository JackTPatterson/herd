...
final class PromptEditor: ObservableObject {
    ...
    private func log(_ message: String) {
        #if DEBUG
        guard ProcessInfo.processInfo.environment["HERD_PROMPT_LOG"] != nil else { return }
        FileHandle.standardError.write(Data("herd: prompt \(message)\n".utf8))
        #endif
    }
    ...
    private func followAnchor() {
        ...
        let current = HerdTerminalRuntime.cursorAnchor()
    ...
    /// Escape, Tab, or a key Herd doesn't handle: give the shell what was
